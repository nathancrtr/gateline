---
name: analyst
description: Turns an intent brief into a numbered, testable spec. Dispatch with the run slug, e.g. "run runs/wordfreq". Produces runs/<slug>/spec.md per contracts/spec.md.
