...
this repository itself (`runs/creation-seam/`, `runs/web-staging/`, `runs/fleetview-design/`);
the gate frontend and the v1 orchestrator it describes in §7 are implemented (`frontend/`)
