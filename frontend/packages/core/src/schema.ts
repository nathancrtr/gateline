...
// Task statuses from contracts/work-item.yaml. A task is "complete for G2"
...
export const TASK_STATUSES = ['pending', 'in-progress', 'in-review', 'review-approved', 'verified', 'done'] as const
